...
import HebxCheckersHebxCheckersCheckers from './hebx/checkers/hebx.checkers.checkers'
...
export default { 
  ...
  HebxCheckersHebxCheckersCheckers: load(HebxCheckersHebxCheckersCheckers, 'hebx.checkers.checkers'),
